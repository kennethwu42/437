...
const profilePath = import_path.default.resolve(
  __dirname,
  "..",
  "..",
  "..",
...
import_fs.promises.readFile(profilePath, "utf-8").then((text) => {
...
router.put("/:userid", async (req, res) => {
  ...
  if (userid === mockProfile.userid) {
    ...
    try {
      await import_fs.promises.writeFile(profilePath, JSON.stringify(mockProfile, null, 2));
